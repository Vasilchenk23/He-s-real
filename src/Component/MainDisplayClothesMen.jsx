...
const MainDisplayClothesMen = () => {
  ...
  async function fetchProductDetails() {
    try {
      const productDetailsResponse = await pb.collection('menCollection').getOne(productId);
  ...
  return (
    ...
    <div className="clothes-details">
      ...
      {isBuyButtonClicked && <ShoppingBag department={'men'} productDetails={productDetails} setQuantity={setQuantity} />}
      <div>
        {cartCounter > 0 && (
...
export default MainDisplayClothesMen;
