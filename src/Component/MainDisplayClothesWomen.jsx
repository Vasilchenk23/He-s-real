...
const MainDisplayClothesWomen = () => {
  ...
  async function fetchProductDetails() {
    try {
      const productDetailsResponse = await pb.collection('womenCollection').getOne(productId);
  ...
  return (
    ...
    <div className="clothes-details">
      ...
      {isBuyButtonClicked && <ShoppingBag department={'women'} productDetails={productDetails} setQuantity={setQuantity} />}
      <div>
        {cartCounter > 0 && (
...
export default MainDisplayClothesWomen;
