  ...
  return (
    <>
      ...
      <div className="clothes-details">
        <img className='imageMainClothes' src={`http://0.0.0.0:8080/api/files/${productDetails.collectionId}/${productDetails.id}/${productDetails.image[0]}?token=`} alt={productDetails.productName} />
