  ...
  return (
    <>
      ...
      <div className="clothes-details">
        <img className='imageMainClothes' src={`http://127.0.0.1:8090/api/files/${productDetails.collectionId}/${productDetails.id}/${productDetails.image[0]}?token=`} alt={productDetails.productName} />
